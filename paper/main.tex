...
% TODO(authors): replace the author block below with real names, affiliations,
% and contact emails before arXiv submission.
...
% TODO(authors): replace with real author names / affiliations / emails.
\author{Eulogik}
\date{September 2026}
...
and we do not try. Our claim is strictly system-vs-system under
identical serving: Yantra beats the reference $3.52\times$ when both
...
\bibitem{yantra}
Eulogik.
\newblock Yantra-1B-Agent weights; Yantra training and evaluation pipeline.
\newblock \url{https://huggingface.co/eulogik/yantra-1b-agent} and
  \url{https://github.com/eulogik/yantra}, 2026. MIT license.
