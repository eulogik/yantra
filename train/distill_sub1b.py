...
Distills the trained NanoAgent-1B teacher into a 0.5B student (optionally
...
def main() -> None:
    ...
    ap.add_argument("--teacher", required=True, help="NanoAgent-1B merged")
    ap.add_argument("--student", required=True, help="0.5B base")
    ap.add_argument("--out", default="train/outputs/nanogent-0.5b")
